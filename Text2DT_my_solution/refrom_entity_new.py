...
# json_data=json.load(open("data/Text2DT/Text2DT_uie_result_test.json","r"))
import json
json_data=json.load(open("data/Text2DT/Text2DT_uie_result_sub_fancy.json","r"))

schema=["基本情况","临床表现","治疗药物","治疗方案","用法用量",'禁用药物']
# relation_data=json.load(open("data/Text2DT/Text2DT_uie_relation2_result_test.json","r"))
relation_data=json.load(open("data/Text2DT/Text2DT_uie_relation2_result_sub_fancy.json","r"))
...
json.dump(triple_lists,open("data/Text2DT/Text2DT_tree_triplets_sub.json","w+"),ensure_ascii=False)   

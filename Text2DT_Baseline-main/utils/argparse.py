...
class ConfigurationParer():
    ...
    def add_data_cfgs(self):
        ...
        self.parser.add('-label_file', '--label_file', type=str, required=False, help='triple-pair label file.')
    ...
    def add_model_cfgs(self):
        ...
        group.add('-node_separate_threshold',
                  '--node_separate_threshold',
                  type=float,
                  default=0.9,
                  help='the threshold for node separating.')
    ...
    def parse_args(self):
        ...
        for file in ['train_file', 'dev_file', 'test_file', 'label_file']:
